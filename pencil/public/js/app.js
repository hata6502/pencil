            ...
            function(e) {
                ...
                function Q(e, t, n, r) {
                    ...
                    var u = /\s*,\s*|\s+/,
                        c =
                            -1 !== s
                                ? [a.slice(0, s).concat([a[s].split(u)[0]]), [a[s].split(u)[1]].concat(a.slice(s + 1))]
                                : [a]
                    return (
        ...
        !(function(t, n) {
            ...
            E.ajaxSetup({
                ...
                (m.createHTMLDocument =
                    (((Ut = a.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'),
